...
This script is called by the plugin-wrapper, ClassifyPetriDing.js, which passes down the
...
from ClassifyPetriDing import ClassifyPetriDing
...
plugin = ClassifyPetriDing(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
